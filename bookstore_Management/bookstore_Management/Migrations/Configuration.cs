...
namespace bookstore_Management.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<bookstore_Management.Data.Context.BookstoreDbContext>
    {
        ...
        protected override void Seed(bookstore_Management.Data.Context.BookstoreDbContext context)
        {
            ...
            {
                new Customer { CustomerId = "KH0031", Name = "Trần Minh Hoàng", Phone = "0904567891", Email = "minhhoang@gmail.com", Address = "Quận Bình Thạnh", MemberLevel = MemberTier.Gold, LoyaltyPoints = 4800, CreatedDate = DateTime.Now },
                new Customer { CustomerId = "KH0032", Name = "Nguyễn Thị Diệu Linh", Phone = "0915678902", Email = "dieulinh@gmail.com", Address = "Quận Phú Nhuận", MemberLevel = MemberTier.Bronze, LoyaltyPoints = 90, CreatedDate = DateTime.Now },
            ...
            var users = new List<User>
            {
                ...
                new User { UserId = "NV0013", Username = "sales.staff08", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0013", CreatedDate = DateTime.Now },
                new User { UserId = "NV0014", Username = "inventory.manager03", PasswordHash = Encryptor.Hash("Inventory@123"), StaffId = "NV0014", CreatedDate = DateTime.Now },
                ...
                new User { UserId = "NV0016", Username = "sales.staff10", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0016", CreatedDate = DateTime.Now },
                new User { UserId = "NV0017", Username = "inventory.manager04", PasswordHash = Encryptor.Hash("Inventory@123"), StaffId = "NV0017", CreatedDate = DateTime.Now },
                new User { UserId = "NV0018", Username = "sales.staff11", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0018", CreatedDate = DateTime.Now },
                new User { UserId = "NV0019", Username = "sales.staff12", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0019", CreatedDate = DateTime.Now },
                new User { UserId = "NV0020", Username = "inventory.manager05", PasswordHash = Encryptor.Hash("Inventory@123"), StaffId = "NV0020", CreatedDate = DateTime.Now },
                new User { UserId = "NV0021", Username = "sales.staff13", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0021", CreatedDate = DateTime.Now },
                ...
                new User { UserId = "NV0023", Username = "sales.staff15", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0023", CreatedDate = DateTime.Now },
                new User { UserId = "NV0024", Username = "cust.manager03", PasswordHash = Encryptor.Hash("CustManager@123"), StaffId = "NV0024", CreatedDate = DateTime.Now },
                new User { UserId = "NV0025", Username = "sales.staff16", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0025", CreatedDate = DateTime.Now },
                new User { UserId = "NV0026", Username = "sales.staff17", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0026", CreatedDate = DateTime.Now },
                new User { UserId = "NV0027", Username = "inventory.manager06", PasswordHash = Encryptor.Hash("Inventory@123"), StaffId = "NV0027", CreatedDate = DateTime.Now },
                new User { UserId = "NV0028", Username = "sales.staff18", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0028", CreatedDate = DateTime.Now },
                new User { UserId = "NV0029", Username = "sales.staff19", PasswordHash = Encryptor.Hash("SalesStaff@123"), StaffId = "NV0029", CreatedDate = DateTime.Now },
                new User { UserId = "NV0030", Username = "admin2", PasswordHash = Encryptor.Hash("Admin@123"), StaffId = "NV0030", CreatedDate = DateTime.Now }
            };
